...
class ConnectionManager:
    ...
    async def connect(self, websocket: WebSocket):
        ...
        await self.send_message(websocket, json.dumps({"isMe": True, "message": "Have joined!!", "username": "You"}))
    ...
    async def broadcast(self, webSocket: WebSocket, data: str):
        ...
        for connection in self.active_connections.values():
            ...
            await connection.send_text(json.dumps({"isMe": is_me, "message": decoded_data['message'], "username": decoded_data['username']}))
